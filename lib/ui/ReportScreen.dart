...
class _ReportScreenState extends State<ReportScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    ever(app.appController.reportRefreshTrigger, (_) => _refreshReportData());
    ever<int>(app.appController.selectedTabIndexRx, (tabIndex) {
      if (tabIndex == 2) {
        SchedulerBinding.instance.addPostFrameCallback((_) => _refreshReportData());
      }
    });
      ...
      child: Container(
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              Text("${date.day}", style: TextStyle(fontWeight: FontWeight.bold, color: isCurrentMonth ? Colors.black : Colors.grey[600])),
              SizedBox(height: 2),
              if (report != null) ...[
...
// import 'package:food_app/ui/order_history.dart';
// import 'package:get/get.dart';
// import 'package:intl/intl.dart';
// import 'package:lottie/lottie.dart';
// import 'package:shared_preferences/shared_preferences.dart';
...
// //
// //             showCalendar
// //                 ? (_selectedDate != null ? _historyStatus(_selectedReport ?? _currentDateReport ?? reportsss) : SizedBox.shrink())
// //                 : _todayStatus(),
// //             const SizedBox(height: 16),
// //           ],
// //         ),
...
// //     if (showCalendar && _selectedDate == null) {
...
// //       storeId = int.tryParse(storeIdString) ?? 13; // Default fallback
// //     } else {
// //       storeId = 13; // Default store ID
